...
const Login: NextPage<Props> = ({ }) => {
  ...
  return (
    <div className='gird-my-auto from-primary-50 to-primary-50 flex items-center bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] via-primary-100 sm:h-screen'>
